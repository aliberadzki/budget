 ...
 */
public class IncomeCategory implements CashFlowCategory {
    ...
    public IncomeCategory(Integer categoryId, String description, Double amount, DateRange startingFrom) throws Exception {
    ...
    public IncomeCategory(Integer id, Integer masterCategoryId, String name, Double plannedAmount, DateRange date) throws Exception {
